...
export default {
  ...
  illustrate(wordMeaning) {
    ...
    word_ele.classList.add('selected-word');
    ...
    if (wordMeaning['uk-phonetic-symbol'] && wordMeaning['us-phonetic-symbol']) {
      ...
      pronunce_ele.classList.add('pronunce');
    ...
    if (wordMeaning['custom-translation']) {
      ...
      custom_translation_ele.classList.add('definition');
    ...
    if (wordMeaning['yodao-web-dict']) {
      ...
      yodao_web_dict_ele.classList.add('definition');
